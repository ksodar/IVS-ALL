...
function isVisible(){
    $('#iframeelement').each(function(){
        if($(this).is(':visible')){
			...
			$('#iframeelement').html('<iframe src="https://opencartadmin.com/doc/index.<?php echo substr(strtolower($config->get('config_admin_language')), 0,2); ?>.html" style="width: 100%; height: 100%; min-height: '+ if_height +'px; border-top: 1px solid #AAA; border-bottom: 1px solid #AAA;"></iframe>');
...
<div class="margintop5px">
<a href="<?php echo $language->get('url_download_new_version'); ?>" target="_blank" class="markbutton widthbutton sc_button"  style="clear:both; "><div><img src="view/image/seocms/sc_menu_d.png" ></div>
