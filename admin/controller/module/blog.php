...
class ControllerModuleBlog extends Controller
{
	...
	public function index()
	{
		...
		$this->data['url_convertor_shopstore'] = $this->url->link('convertor/shopstore', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->data['url_delete_all_connect'] = $this->url->link('module/blog/uninstall', 'token=' . $this->session->data['token'], 'SSL');
        ...
        if (SC_VERSION < 23) {
			...
			$this->data['url_modules'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'], 'SSL');
        ...
        if (SC_VERSION < 23) {
			$module_breadcrumbs_href = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$module_breadcrumbs_href = $this->url->link('extension/extension', 'token=' . $this->session->data['token'], 'SSL');
		}
