  	...
  	private function getForm() {
		...
		foreach ($results as $result) {
			...
			$data['seo'] = array(
				...
				'prod_meta_desc'	  	  => $result['prod_meta_desc'],
				'prod_desc'		 		  => $result['prod_desc'],				
				'cat_title'		  	  	  => $result['cat_title'],				
				'cat_meta_desc'		  	  => $result['cat_meta_desc'],
				'cat_desc'		  	  	  => $result['cat_desc'],				
				'manuf_title'	  	  	  => $result['manuf_title'],				
				'manuf_meta_desc'	  	  => $result['manuf_meta_desc'],
				'manuf_desc'	  	  	  => $result['manuf_desc'],
				'prod_keyword'            => $result['prod_keyword'],
				'prod_url'            	  => $result['prod_url'],
				'prod_h1'				  => $result['prod_h1'],
				'prod_photo'			  => $result['prod_photo'],
				'seo_1'	  	  	  		  => $result['seo_1'],
				'seo_2'	  	  	  		  => $result['seo_2'],
				'seo_3'	  	  	  		  => $result['seo_3'],
				'seo_4'	  	  	  		  => $result['seo_4'],
				...
				'seo_8'	  	  	  		  => $result['seo_8'],
				'seo_9'	  	  	  		  => $result['seo_9'],
				'seo_10'	  	  	  	  => $result['seo_10'],
				'seo_11'	  	  	  	  => $result['seo_11'],
				'seo_12'	  	   		  => $result['seo_12'],
				'seo_13'	  	  	  	  => $result['seo_13'],
				'seo_14'	  	  	  	  => $result['seo_14'],
				'seo_15'	  	   		  => $result['seo_15'],
				'seo_16'	  	  	  	  => $result['seo_16'],
				'seo_17'	  	  	  	  => $result['seo_17'],
				'seo_18'	  	   		  => $result['seo_18'],
				'seo_19'	  	  	  	  => $result['seo_19'],
				'seo_20'	  	  	  	  => $result['seo_20'],				
				'action'      			  => $action
			);
			...
			if (isset($this->request->post['prod_url'])) {
				$data['prod_url'] = $this->request->post['prod_url'];
			} else {
				$data['prod_url'] = $result['prod_url'];				
			}
		...
		$data['statuses'] = $this->model_catalog_suppler->getStatus('46', 'status004647012', '46');
