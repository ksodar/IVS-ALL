<?php
//START Парсим robots и дописываем мета тег <meta name="googlebot" content="noindex">
$robots = file_get_contents($_SERVER['DOCUMENT_ROOT'] .'/robots.txt');
preg_match_all('|Disallow:\s?(.*)\n|siU', $robots, $mattch);
$googlebot = '';
$disallow = array();
foreach ($mattch[1] as $rule) {
  $rule = trim(preg_quote($rule));
  $rule = str_replace('\*', '.*', $rule);
  $rule = str_replace('\$', '$', $rule);
  array_push($disallow, $rule);
}
foreach ($disallow as $rule) {
  if (preg_match('|'.$rule.'|siU', $_SERVER['REQUEST_URI'])) {
    $googlebot = '<meta name="googlebot" content="noindex">';
    break;
  }
}
//END Парсим robots и дописываем мета тег <meta name="googlebot" content="noindex">
...
<meta name="yandex-verification" content="79a16b32f04709d8" />
<meta name="google-site-verification" content="xS6wmC8dDGS0oJH9nEVqEC0WygZ3j3eKzpfa6RLY65E" />
<!-- Yandex.Metrika counter -->
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter43209884 = new Ya.Metrika({
                    id:43209884,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/43209884" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
<script>
