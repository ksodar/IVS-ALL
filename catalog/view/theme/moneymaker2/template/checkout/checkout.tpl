		...
		$.ajax({
				...
				success: function(json) {
						...
						if (json['redirect']) {
								...
								$('#popupModal .modal-body').prepend('<div class="panel panel-danger"><div class="panel-heading text-center"><small>' + json['error']['warning'] + '</small></div></div>');
								$('#popupModal').modal();
				...
				success: function(json) {
						...
						if (json['redirect']) {
								...
								if (json['error']['warning']) {
										...
										$('#popupModal .modal-header .close').removeClass('hidden');
										$('#popupModal .modal-title').text('<?php echo $heading_title; ?>');
										$('#popupModal .modal-body').prepend('<div class="panel panel-warning"><div class="panel-heading text-center"><small>' + json['error']['warning'] + '</small></div></div>');
										$('#popupModal').modal();
