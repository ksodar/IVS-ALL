...
if (!class_exists('ControllerModuleBlog')) {
	class ControllerModuleBlog extends Controller
	{
		...
		public function index($arg)
		{
			...
			$this->load->model('setting/setting');
			if ((isset($this->data['settings_general']['seocms_url_secure']) && ($this->data['settings_general']['seocms_url_secure'] == 'https' && $this->data['settings_general']['seocms_url_secure'] != 'http')) || ((isset($_SERVER['HTTPS']) && (strtolower($_SERVER['HTTPS']) == 'on' || $_SERVER['HTTPS'] == '1')) || (!empty($_SERVER['HTTP_X_FORWARDED_PROTO']) && (strtolower($_SERVER['HTTP_X_FORWARDED_PROTO']) == 'https') || (!empty($_SERVER['HTTP_X_FORWARDED_SSL']) && strtolower($_SERVER['HTTP_X_FORWARDED_SSL']) == 'on'))) && (isset($this->data['settings_general']['seocms_url_secure']) && $this->data['settings_general']['seocms_url_secure'] != 'http')) {
		...
		public function ColorboxLoader($theme, $data) {
			...
			if ($this->data['settings_general']['css_dir'] == 'theme') {
				$css_dir = DIR_TEMPLATE.$this->config->get('config_template').'/stylesheet/';
			}
		...
		private function getBlogsRecords($settingswidget, $type = 'latest')
		{
			...
			if ($results) {
				...
				if ((isset($this->data['settings_general']['seocms_url_secure']) && $this->data['settings_general']['seocms_url_secure'] == 'https' && $this->data['settings_general']['seocms_url_secure'] != 'http') || ((isset($_SERVER['HTTPS']) && (strtolower($_SERVER['HTTPS']) == 'on' || $_SERVER['HTTPS'] == '1')) || (!empty($_SERVER['HTTP_X_FORWARDED_PROTO']) && (strtolower($_SERVER['HTTP_X_FORWARDED_PROTO']) == 'https') || (!empty($_SERVER['HTTP_X_FORWARDED_SSL']) && strtolower($_SERVER['HTTP_X_FORWARDED_SSL']) == 'on'))) && $this->data['settings_general']['seocms_url_secure'] != 'http') {
