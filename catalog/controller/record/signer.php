...
class ControllerRecordSigner extends Controller
{
	...
	public function signer($product_id, $record_info, $settings, $mark_id)
	{
		...
		if ((isset($settings['signer_answer']) && isset($settings['signer']) && isset($settings['comments_email'])) && ($settings['signer'] || $settings['signer_answer'] || $notify_status || $settings['comments_email'] != '')) {
