...
$_['error_reg']             = '<div>Отзывы могут оставлять только зарегистрированные пользователи.<br>Пожалуйста <a class="textdecoration_none hrefajax" href="#"><ins class="hrefajax customer_enter">войдите в личный кабинет</ins></a> или <a href="%s">зарегистрируйтесь</a></div>';
$_['error_text']            = 'Текст отзыва должен быть от 3 до 1000 символов!';
